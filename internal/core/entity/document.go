...
// Document is the base type for business transactions (Documents).
...
type Document struct {
	...
	BasisType string `db:"basis_type" json:"basisType,omitempty" meta:"label:Тип основания"`
	BasisID   *id.ID `db:"basis_id"   json:"basisId,omitempty"   meta:"label:Основание"`
