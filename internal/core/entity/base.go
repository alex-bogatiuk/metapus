...
type BaseEntity struct {
	...
	DeletionMark bool `db:"deletion_mark" json:"deletionMark" meta:"label:Пометка удаления"`
...
// GetID returns the entity ID (for generic service/handler code without type assertion).
func (b *BaseEntity) GetID() id.ID {
	return b.ID
}
