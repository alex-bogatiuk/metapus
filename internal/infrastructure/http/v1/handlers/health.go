...
func NewHealthHandler(pool *postgres.Pool, version string) *HealthHandler {
...
func NewHealthHandlerMultiTenant(metaPool *pgxpool.Pool, tenantManager *tenant.Manager, version string) *MultiTenantHealthHandler {
