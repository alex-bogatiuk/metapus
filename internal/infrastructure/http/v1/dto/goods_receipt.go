...
// DocRefsBag bundles resolved reference maps for document handlers.
// Used as the opaque refs bag returned by ResolveRefs callbacks.
type DocRefsBag struct {
	Refs         postgres.ResolvedRefs
	CurrencyRefs postgres.ResolvedCurrencyRefs
}
