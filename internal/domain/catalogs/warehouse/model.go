...
type Warehouse struct {
	...
	Type WarehouseType `db:"type" json:"type" meta:"label:Тип"`

	// Address is the physical address
	Address *string `db:"address" json:"address,omitempty" meta:"label:Адрес"`
	...
	AllowNegativeStock bool `db:"allow_negative_stock" json:"allowNegativeStock" meta:"label:Отриц. остатки"`

	// IsDefault indicates if this is the default warehouse
	IsDefault bool `db:"is_default" json:"isDefault" meta:"label:Основной"`

	// OrganizationID is reference to owning organization
	OrganizationID string `db:"organization_id" json:"organizationId,omitempty" meta:"label:Организация"`
