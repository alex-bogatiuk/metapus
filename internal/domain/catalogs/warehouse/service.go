...
func NewService(
	...
	// Initialize base Generic service
...
// clearDefault resets the default warehouse flag for all records.
func (s *Service) clearDefault(ctx context.Context) error {
	// This is a bulk operation, we leave it in the repository as is.
