// Package nomenclature provides the Nomenclature catalog.
...
const (
	TypeGoods       NomenclatureType = "goods"    // Goods
	TypeService     NomenclatureType = "service"  // Service
	TypeWork        NomenclatureType = "work"     // Work
	TypeMaterial    NomenclatureType = "material" // Material
	TypeSemiProduct NomenclatureType = "semi"     // Semi-finished product
	TypeProduct     NomenclatureType = "product"  // Finished product
)
