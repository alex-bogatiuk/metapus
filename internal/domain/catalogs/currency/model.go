// Package currency provides the Currency catalog.
...
type Currency struct {
	...
	ISOCode *string `db:"iso_code" json:"isoCode" meta:"label:ISO код"`

	// ISONumericCode is the ISO 4217 numeric code (e.g., 840, 978, 643)
	ISONumericCode *string `db:"iso_numeric_code" json:"isoNumericCode,omitempty" meta:"label:Цифровой код"`
	...
	DecimalPlaces int `db:"decimal_places" json:"decimalPlaces" meta:"label:Знаков после запятой"`
	...
	Country *string `db:"country" json:"country,omitempty" meta:"label:Страна"`
}
