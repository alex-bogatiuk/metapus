...
// Repository defines operations for crypto withdrawal documents.
type Repository interface {
	...
	GetLines(ctx context.Context, docID id.ID) ([]CryptoWithdrawalLine, error)
	SaveLines(ctx context.Context, docID id.ID, lines []CryptoWithdrawalLine) error
