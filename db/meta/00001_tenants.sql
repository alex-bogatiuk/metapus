...
CREATE TABLE IF NOT EXISTS tenants (
    ...
    schema_version  INT NOT NULL DEFAULT 0,           -- Highest applied goose migration number
    version_group   VARCHAR(20) NOT NULL DEFAULT '',  -- Server version group (cloud mode: "v1.3.0")
...
CREATE INDEX idx_tenants_version_group ON tenants(version_group, status) WHERE status = 'active';
