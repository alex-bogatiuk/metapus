-- +goose Up
-- Description: Goods Receipt document (Документ "Поступление товаров")
...
-- Keyset pagination
CREATE INDEX idx_doc_goods_receipts_date_id    ON doc_goods_receipts (date DESC, id DESC);
CREATE INDEX idx_doc_goods_receipts_created_id ON doc_goods_receipts (created_at DESC, id DESC);
