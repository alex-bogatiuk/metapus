...
| [systems/crypto-processing.md](systems/crypto-processing.md) | Криптопроцессинг: chain watcher, FSM, event processor, compliance, settlement, threshold sweep, allocation mode, merchant config | crypto, payment, blockchain, tron, watcher, fsm, invoice, wallet, webhook, settlement, compliance, sweep, threshold, allocation, merchant config |
