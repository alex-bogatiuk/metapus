...
Подсистема Автоматизации — отказоустойчивый, изолированный по тенантам механизм реагирования на бизнес-события. Вводит трёхуровневую модель доставки (**Account → Channel → Subscriber**), двухфазный движок, CRON-планировщик и AES-256-GCM шифрование учётных данных.
