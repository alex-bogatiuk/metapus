...
│       ├── factory_registry.go   # FactoryRegistry + RegisterDefaults() + RouteRegistration
│       ├── catalog_factory.go    # CatalogRegistration interface + concrete factories
│       ├── document_factory.go   # DocumentRegistration interface + concrete factories
│       ├── register_registrations.go  # RouteRegistration impls for registers/reports
