...
## 14. Сквозной поток: от транзакции до подтверждения
...
## 15. Архитектурные решения и trade-offs
...
### 17.1. Аутентификация (MerchantAPIKey Middleware)
...
### 17.4. Admin API (управление API-ключами)
...
### 17.5. SSRF-защита (ValidateCallbackURL)
...
### 17.7. Сквозной поток: создание инвойса через API
